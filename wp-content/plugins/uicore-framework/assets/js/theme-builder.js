...
var _vueColor = __webpack_require__(21);
...
var _rule = __webpack_require__(423);
...
exports.default = {
    ...
    methods: {
        ...
        addHandlers: function addHandlers() {
            var _this = this;
            console.log('addHandlers', jQuery('.row-actions .edit a, .page-title-action, body.post-type-uicore-tb a.row-title, body.post-type-uicore-tb a.page-title-action'));
...
var render = function() {
  ...
  return _c("div", {
    domProps: {
      innerHTML: _vm._s(__webpack_require__(23)("./icon-" + this.icon + ".svg"))
    },
    on: {
...
var map = {
	"./icon-admin-customizer.svg": 24,
	"./icon-animations.svg": 25,
	"./icon-blog.svg": 26,
	"./icon-branding.svg": 27,
	"./icon-buttons.svg": 28,
	"./icon-close.svg": 29,
	"./icon-custom.svg": 30,
	"./icon-dark-mode.svg": 31,
	"./icon-dashboard.svg": 32,
	"./icon-debug.svg": 33,
	"./icon-demo-loader.svg": 34,
	"./icon-desktop.svg": 35,
	"./icon-documentation.svg": 36,
	"./icon-edit.svg": 37,
	"./icon-feedback.svg": 38,
	"./icon-footer.svg": 39,
	"./icon-general.svg": 40,
	"./icon-global-colors.svg": 41,
	"./icon-global-fonts.svg": 42,
	"./icon-global.svg": 43,
	"./icon-header.svg": 44,
	"./icon-import-preset.svg": 45,
	"./icon-import.svg": 46,
	"./icon-light-mode.svg": 47,
	"./icon-page-title.svg": 48,
	"./icon-performance.svg": 49,
	"./icon-phone.svg": 50,
	"./icon-plugins.svg": 51,
	"./icon-portfolio.svg": 52,
	"./icon-preset.svg": 53,
	"./icon-presetm.svg": 54,
	"./icon-remove-preset.svg": 55,
	"./icon-search.svg": 56,
	"./icon-social.svg": 57,
	"./icon-success.svg": 58,
	"./icon-system.svg": 59,
	"./icon-tablet.svg": 60,
	"./icon-theme-skin.svg": 61,
	"./icon-top-banner.svg": 62,
	"./icon-typography.svg": 63,
	"./icon-updates.svg": 64,
	"./icon-warning.svg": 65,
	"./icon-woo.svg": 66
};
...
var _ThemeBuilder = __webpack_require__(421);
...
var _vue2PerfectScrollbar = __webpack_require__(81);

var _vue2PerfectScrollbar2 = _interopRequireDefault(_vue2PerfectScrollbar);

var _uicoreMultiselect = __webpack_require__(427);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_ThemeBuilder_vue__ = __webpack_require__(177);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_57cbf9ba_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_ThemeBuilder_vue__ = __webpack_require__(426);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_rule_vue__ = __webpack_require__(178);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_396a6726_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_rule_vue__ = __webpack_require__(425);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_uicoreMultiselect_vue__ = __webpack_require__(179);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3acb0aa1_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_uicoreMultiselect_vue__ = __webpack_require__(428);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_bd6236d4_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_SvgIcon_vue__ = __webpack_require__(22);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
